      ...
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6 text-white">
          <h1 className="text-4xl font-bold">
            About <span className="text-orange-400">DevChauk</span>
          </h1>

          <p className="text-gray-300 leading-relaxed">
            DevChauk is a service-based IT platform designed to connect skilled
            developers with clients looking for reliable digital solutions. We
            aim to simplify the process of finding the right talent for the
            right project through a transparent and community-driven approach.
          </p>
          ...
          <p className="text-gray-300 leading-relaxed">
            At DevChauk, we believe in creating a trusted digital marketplace
            that empowers developers and helps businesses grow. Our vision is to
            build a strong ecosystem where technology, collaboration, and
